...
public:
	...
	static bool boxAndSphere(const AABB& aabb, const Sphere& sphere, CollisionData* data = nullptr);
	static bool boxAndPlain(const AABB& aabb, const Plain& Plain, CollisionData* data = nullptr);
	static bool sphereAndTruePlain(const Sphere& sphere, const Plain& Plain, CollisionData* data = nullptr);
	static bool sphereAndSphere(const Sphere& one, const Sphere& two, CollisionData* data = nullptr);
	...
	static bool boxVsBox(const AABB& box1, const AABB& box2, CollisionData* data = nullptr);
